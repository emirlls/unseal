...
namespace Unseal.Migrations
{
    ...
    [Migration("20260207181252_AddedPasswordResetOnNotificationEventTypeTables")]
    partial class AddedPasswordResetOnNotificationEventTypeTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unseal.Entities.Groups.GroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Unseal.Entities.Users.UserInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_interactions", "unseal");
                });
            ...
            modelBuilder.Entity("Unseal.Entities.Capsules.CapsuleItem", b =>
                {
                    b.HasOne("Unseal.Entities.Capsules.Capsule", "Capsule")
                        .WithOne("CapsuleItems")
                        .HasForeignKey("Unseal.Entities.Capsules.CapsuleItem", "CapsuleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Unseal.Entities.Capsules.CapsuleMapFeature", b =>
                {
                    b.HasOne("Unseal.Entities.Capsules.Capsule", "Capsule")
                        .WithOne("CapsuleMapFeatures")
                        .HasForeignKey("Unseal.Entities.Capsules.CapsuleMapFeature", "CapsuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Unseal.Entities.Groups.GroupMember", b =>
                {
                    b.HasOne("Unseal.Entities.Groups.Group", "Group")
            ...
            modelBuilder.Entity("Unseal.Entities.Users.UserInteraction", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "SourceUser")
                        .WithMany()
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("f_k_user_interactions_users_source_user_id");

                    b.HasOne("Volo.Abp.Identity.IdentityUser", "TargetUser")
                        .WithMany()
                        .HasForeignKey("TargetUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("f_k_user_interactions_users_target_user_id");
